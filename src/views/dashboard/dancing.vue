<template>
  <div class="variety">
    ...
    <el-card style="width: 100%;">
      <el-row :gutter="60">
      <el-col :span="12" v-for="(item, index) in variety" :key="index" style="margin-bottom: 30px">
        <!-- 封面 -->
        <div id="Detail">
        ...
        <!-- 介绍 -->
        <div id="Intro">
          <p style="margin: 1;font-weight: bolder;font-size: larger;" id="title">{{ item.roomTitle }}</p>
